...
<!-- menu_admin_campo.php -------------------------------------------------------------------------

     Menu de administracion de campo de texto del sitio DLACT:Corpus Textual. Se listan todos los 
     campos de texto y todas las funciones que pueden realizarse.
...
<?php  
   ...
   if(tienePermisos("textocampomenuadmin"))
   {
?>
   ...
   <tr>
      <td align="center" width="150" valign="top" bgcolor="#FFFF99" class="conborde">
         <p align="center"><br><span class="titulo titulo_gris"><?php echo $operaciones ?></span><br><br>
           <input type="button" class="boton boton_nuevo" value="       <?php echo $nuevo_campo ?> " onclick="document.location='operacion_campo.php?arg_op=nuevo';"/><br><br>
		 ...
		 <a href="../../ayuda/ayuda_admin_campo.htm" target="_blank"><span class="subtitulo titulo_rojo"><img border="0" src="../../imagenes/ayuda.png" width="43" height="24" /><br><?php echo $ayuda ?></span></a><br>&nbsp;
      </td>
      <td>
<?php  
      listar_campos();    
...
<table border="0" width="100%" style="border-top: 1 solid #FF0000">
   <tr>
	  ...
	  <td class="Pie"><a href="../../principal.php"><?php echo $menu_principal ?></a> > <a href="../menu_admin_texto.php"><?php echo $titulo_menu_admin_texto ?></a> > <u><?php echo $titulo_menu_admin_campo ?></u<</td>
   </tr>
</table>
