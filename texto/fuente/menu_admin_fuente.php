...
<!-- menu_admin_fuente.php ------------------------------------------------------------------------

     Menu de administracion de fuente de texto del sitio DLACT:Corpus Textual. Se listan todas 
   las fuentes de texto y todas las funciones que pueden realizarse.
...
<?php  
   ...
   if(tienePermisos("textofuentemenuadmin"))
   {
?>
   ...
   <tr>
      <td align="center" width="150" valign="top" bgcolor="#FFFF99" class="conborde">
         <p align="center"><br><span class="titulo titulo_gris"><?php echo $operaciones ?></span><br><br>
           <input type="button" class="boton boton_nuevo" value="       <?php echo $nueva_fuente ?> " onclick="document.location='operacion_fuente.php?arg_op=nuevo';"/><br><br>
		 ...
		 <a href="../../ayuda/ayuda_admin_fuente.htm" target="_blank"><span class="subtitulo titulo_rojo"><img border="0" src="../../imagenes/ayuda.png" width="43" height="24" /><br><?php echo $ayuda ?></span></a><br>&nbsp;</td>
      <td >
<?php  
      listar_fuentes(); 	  
?> 
...
<table border="0" width="100%" style="border-top: 1 solid #FF0000">
   <tr>
	  ...
	  <td class="Pie"><a href="../../principal.php"><?php echo $menu_principal ?></a> > <a href="../menu_admin_texto.php"><?php echo $titulo_menu_admin_texto ?></a> > <u><?php echo $titulo_menu_admin_fuente?></u<</td>
   </tr>
</table>
