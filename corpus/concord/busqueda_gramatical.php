...
<!-- menu_concord.php ---------------------------------------------------------------------------
     ...
     Pagina que presenta el formulario para la busqueda de las coocurrencias por categoria gramatical.
...
<head>
	<title>Caliope</title>
	<link rel="stylesheet" type="text/css" href="../../CSS/busqueda_gramatical.css">
	...
	function postbackComplete( contenedor, respuesta) {
		...
		eval (respuesta);
		var iniciotabla = "<table width=80% border='1' cellpadding='4' cellspacing='1' bgcolor='#CC0000'>";
		var fintabla = "</table>";
		var textocabecera = "";
		var textoseparador = "";
	...
	function buscarConcordancias2() 
	{
		...
		if (document.formulario.nuevoTermino.value == "") {
			...
			if (!hayDocsSeleccionados) {
				...
				alert("<?php echo $busqueda_solo_eurowordnet ?>");
				form.submit();
			}
		}
	}
...
<p align="center">
<table  width="80%" border="0" bgcolor="#FFFFFF" cellpadding="5" cellspacing="5">
   <tr>
      <td colspan="4">
		  ...
		  <tr>
		    <td>
				...
				<tr id="first_row">
					...
					<td><input type="text" id="nuevoTermino" name="nuevoTermino" size="30" maxlength="100" title="<?php echo $mensaje63 ?>"></td>
					<td align="right">&nbsp;<?php echo $categoria_gramatical ?>:
						<select id="categoria" name="categoria" title="<?php echo $categoria_gramatical ?>">
							<option value="n"><?php echo $nomb ?></option>
							<option value="a"><?php echo $adjetivo ?></option>
							<option value="v"><?php echo $verbo ?></option>
						</select>
					</td>
				</tr>
				<tr>
				    <td align="center">&nbsp;<?php echo $ent ?>:&nbsp;&nbsp; </td>
					<td>    <select id="entorno" name="entorno" title="<?php echo $ent ?>">
					...
					<td align="right">&nbsp;<?php echo $busq_donde?>:
		      	         <select id="donde_buscar" name="donde_buscar" title="<?php echo $tit_busqueda ?>">
   ...
   <tr>
      <td align="center" bgcolor="#FFFFFF" colspan="5"><p id="opciones"><?php echo $titulo_texto ?></p></td>
   </tr>
   <tr>
      <td colspan="4">
<?php 
...
?>
   ...
   <tr>
     <td>
   	   <input type="button" value="<?php echo $conc ?>" onclick="buscarConcordancias2();"/>&nbsp;&nbsp;
   	 </td>
     <td>
